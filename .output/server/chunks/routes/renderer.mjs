...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Ugarit Center"}],"link":[{"rel":"icon","href":"/logo","type":"image/x-icon"}],"style":[],"script":[],"noscript":[],"title":"Wissam Najjom","htmlAttrs":{"lang":"en"}};
