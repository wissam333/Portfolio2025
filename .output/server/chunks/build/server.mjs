import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, defineAsyncComponent, readonly, onMounted, nextTick, watch, provide, createElementBlock, useSSRContext, Suspense, mergeProps, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { l as createHooks, m as getContext, j as createError$1, n as toRouteMatcher, o as createRouter, q as defu, r as sanitizeStatusCode, v as executeAsync, w as getRequestHeaders, x as getRequestHeader, y as getRequestProtocol, d as destr, z as klona, A as parse$1, B as isEqual$1, C as setCookie, D as getCookie, E as deleteCookie, F as defuFn } from '../_/nitro.mjs';
...
import { resolve as resolve$1, minifyCSS, isNotEmpty } from '@primeuix/utils/object';
...
const LazyIcon = defineAsyncComponent(() => import('./index2.mjs').then(function (n) { return n.i; }).then((r) => r["default"] || r.default || r));
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b57493ff"]]);
...
export { BaseStyle as B, _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, withoutTrailingSlash as c, nuxtLinkDefaults as d, useHead as e, fetchDefaults as f, useRequestFetch as g, hasProtocol as h, useState as i, joinURL as j, useAppConfig as k, asyncDataDefaults as l, createError as m, navigateTo as n, useI18n as o, parseQuery as p, __nuxt_component_0$1 as q, resolveRouteObject$1 as r, server as s, useRouter as u, withTrailingSlash as w };
