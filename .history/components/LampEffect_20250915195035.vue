    ...
    >
      ...
      <div
        :style="{
          ...
          animation: `conic-gradient-anim ${durationInSeconds} ease-in-out forwards`,
          animationDelay: delayInSeconds,
        }"
        class="bg-gradient-conic absolute inset-auto right-1/2 h-56 w-60 overflow-visible from-cyan-500 via-transparent to-transparent text-white opacity-50 [--conic-position:from_70deg_at_center_top]"
      >
        <div
      ...
      <div
        ...
        class="bg-gradient-conic absolute inset-auto left-1/2 h-56 w-60 from-transparent via-transparent to-cyan-500 text-white opacity-50 [--conic-position:from_290deg_at_center_top]"
      >
        <div
      ...
      <div
        :style="{
          animation: `spotlight-anim ${durationInSeconds} ease-in-out forwards`,
          animationDelay: delayInSeconds,
        }"
        class="absolute inset-auto z-30 h-36 w-32 -translate-y-24 rounded-full bg-cyan-400 blur-2xl"
      ></div>

      <!-- Glowing Line -->
      <div
        :style="{
          animation: `glowing-line-anim ${durationInSeconds} ease-in-out forwards`,
          animationDelay: delayInSeconds,
        }"
        class="absolute inset-auto z-50 h-0.5 w-60 -translate-y-28 bg-cyan-400"
      ></div>
