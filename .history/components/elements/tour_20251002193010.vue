<template>
  <div v-if="isActive" class="ui-tour">
    <!-- Overlay -->
...
function updatePositions() {
  ...
  // Jump instantly to element to get correct coordinates
...
.ui-tour {
  ...
  height: 100%;
  z-index: 2000;
  pointer-events: none; /* only children handle pointer events */
}
...
.ut-overlay {
  ...
  pointer-events: auto; /* intercept clicks only when active */
}
