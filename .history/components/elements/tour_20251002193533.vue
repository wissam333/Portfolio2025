...
function updatePositions() {
  ...
  // Jump instantly to element to measure correct rect
...
<style scoped>
/* Overlay covering viewport visually but not blocking scroll */
.ut-overlay {
  position: fixed;
  inset: 0;
  background: rgba(0, 0, 0, 0.6);
  backdrop-filter: blur(2px);
  pointer-events: none; /* overlay does not block scroll */
  z-index: 2000;
}
