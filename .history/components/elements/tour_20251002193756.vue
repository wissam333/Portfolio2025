...
async function updatePositions() {
  ...
  if (!el) {
    ...
    tooltipStyle.value = {
      ...
      left: (window.innerWidth - 360) / 2 + scrollX + "px",
    };
    focusTooltip();
    return;
  }

  // Jump instantly to element to get rect
  ...
  // Smooth scroll separately after positions set
  window.scrollTo({
    top: absTop - window.innerHeight / 2 + rect.height / 2,
    left: absLeft - window.innerWidth / 2 + rect.width / 2,
    behavior: "smooth",
  });
