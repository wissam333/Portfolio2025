...
// Realistic cloud types for snowy night
const cloudTypes = [
  {
    name: "nimbostratus",
    layers: 6,
...
.snowy-night-container {
  ...
  min-height: 30vh;
  overflow: hidden;
  background: linear-gradient(to bottom, #050814 0%, #0a0f1f 100%);
}
...
/* Nimbostratus - heavy snow clouds with more organic shape */
.cloud-nimbostratus {
  width: 180px;
  height: 70px;
  background: #0f1425;
