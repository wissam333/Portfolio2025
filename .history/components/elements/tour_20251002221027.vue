...
async function updatePositions() {
  ...
  if (overlay) {
    ...
    overlay.style.webkitMaskImage = `radial-gradient(circle ${radius}px at ${centerX}px ${centerY}px, transparent 0%, black 100%)`;
    overlay.style.maskImage = `radial-gradient(circle ${radius}px at ${centerX}px ${centerY}px, transparent 0%, black 100%)`;
  }
