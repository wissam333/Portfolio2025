...
.glow-cursor.glow {
  ...
  background: radial-gradient(
    ...
    rgba(255, 255, 255, 0.251) 40%,
    transparent 100%
  );
  box-shadow: 0 0 40px rgba(255, 255, 255, 0.723),
    0 0 80px rgba(255, 255, 255, 0.442);
...
.glow-cursor.flashlight {
  ...
  background: radial-gradient(
    circle,
    rgba(255, 255, 255, 0.685) 0%,
    rgba(255, 255, 255, 0.08) 55%,
    transparent 100%
  );
  box-shadow: 0 0 80px rgba(79, 192, 141, 0.51);
  mix-blend-mode: screen;
}
