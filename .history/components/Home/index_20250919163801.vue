<template>
  <div class="home">
    ...
    <div class="hidden-elements-container" id="hiddenPage">
      <div class="hidden-item" style="top: 30%; left: 20%">HTML5</div>
      <div class="hidden-item" style="top: 60%; left: 70%">CSS3</div>
      <div class="hidden-item" style="top: 40%; left: 80%">JavaScript</div>
      <div class="hidden-item" style="top: 70%; left: 30%">Vue.js</div>
      <div class="hidden-item" style="top: 50%; left: 50%">Nuxt 3</div>
    </div>
...
.glow-cursor {
  ...
  height: 12px;
  border-radius: 50%;
  background: rgba(255, 255, 255, 0.4); /* slightly stronger core */
...
.glow-cursor.glow {
  ...
  background: radial-gradient(
    ...
    /* visible center */ rgba(255, 255, 255, 0.1) 50%,
    /* soft fade */ transparent 100% /* edges transparent */
  );
...
.glow-cursor.flashlight {
  ...
  background: radial-gradient(
    ...
    /* stronger visible light at center */ rgba(255, 255, 255, 0.08) 55%,
    /* smooth fade out */ transparent 100%
  );
  box-shadow: 0 0 60px rgba(167, 167, 167, 0.45),
    /* soft greenish halo */ 0 0 100px rgba(183, 183, 183, 0.25);
  mix-blend-mode: screen;
}
...
.hidden-elements-container.lit .hidden-item {
  opacity: 1;
  transform: scale(1);
}
</style>
