...
/* ---------- Realistic Glow Cursor ---------- */
.glow-cursor {
  position: fixed;
  transform: translate(-50%, -50%);
  pointer-events: none;
  z-index: 9999;
  width: 8px;                // smaller, like a real cursor dot
  height: 8px;
  border-radius: 50%;
  background: rgba(255, 255, 255, 0.9); // bright but subtle
  box-shadow: 0 0 4px rgba(255, 255, 255, 0.3); // tiny soft halo
...
.glow-cursor.flashlight {
  ...
  background: radial-gradient(
    ...
    /* soft bright center */ rgba(255, 255, 255, 0.05) 70%,
    /* smooth fade */ transparent 100%
  );
  box-shadow: 0 0 60px rgba(255, 255, 255, 0.08); /* very subtle volumetric glow */
  mix-blend-mode: screen;
}
