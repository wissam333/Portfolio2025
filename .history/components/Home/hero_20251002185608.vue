  ...
  <div class="home">
    ...
    <main class="content" ref="contentContainer">
      <div class="type_effect">
        <div class="container">
           <elementsTour :steps="tourSteps" :start="true" />
          <p class="intro-text"  id="feature1" data-aos="fade-up" data-aos-delay="200">
            Hi, I'm
          </p>

          <p class="name" data-aos="fade-up" data-aos-delay="600"  id="btnStart" >
            Wissam Najjom
          </p>

          <p class="role" id="feature2" data-aos="fade-left" data-aos-delay="1000">
            Front End Developer
          </p>
...
<script setup>
const tourSteps = [
  { selector: "#btnStart", title: "Welcome", content: "Click here to begin" },
  {
    selector: "#feature1",
    title: "First Feature",
    content: "Here is feature one",
  },
  {
    selector: "#feature2",
    title: "Second Feature",
    content: "Here is feature two",
  },
];
