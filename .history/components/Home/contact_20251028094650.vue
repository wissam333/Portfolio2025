          ...
          >
            <div class="mb-3">
              <label class="form-label">
                {{ $i18n.locale === "ar" ? "اسمك" : "Your Name" }}</label
              >
              <input
                type="text"
                name="name"
            ...
            <input
              ...
              :value="
                $i18n.locale === 'ar'
                  ? 'مرحباً، هذه رسالة رد تلقائي. سأرد على رسالتك خلال ثلاثة أيام كحد أقصى. في حال عدم الرد، يُرجى الاتصال بي على الرقم 0987319112.'
                  : 'Hey, this is an automatic reply message I will reply to your message within 3 days at most. If there is no response, please call me 0987319112'
              "
            />
