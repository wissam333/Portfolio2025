  ...
  <section class="portfolio-section py-5">
    <div class="container">
      <div class="row align-items-start">
        ...
        <div class="col-lg-6">
          <h2 class="headline mb-0 pb-0">A Collection Of</h2>
          <h2 class="headline pt-0 mt-2">My Work</h2>

          

          <div class="portfolio-items d-flex justify-content-between gap-4 mt-4">
            <!-- Laptop + Mobile in one line -->
            <div class="device-wrapper laptop-mobile gap-3">
              <!-- Mobile -->
