...
.star {
  ...
  /* Attraction effect when cursor is nearby */
  &:hover {
...
/* Add magnetic attraction effect for stars near cursor */
.stars-container {
  position: absolute;
  width: 100%;
  height: 100%;
...
@keyframes pulse {
  0% {
    transform: scale(1);
    box-shadow: 0 0 5px #fff, 0 0 10px rgba(255, 255, 255, 0.7);
  }
  100% {
    transform: scale(1.5);
    box-shadow: 0 0 15px #fff, 0 0 25px rgba(255, 255, 255, 0.9);
  }
}
</style>
