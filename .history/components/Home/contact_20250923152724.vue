<template>
  <section class="contact-section py-5 position-relative">
    ...
    <div class="easter-egg-trigger" @click="activateEasterEgg"></div>
    ...
    >
      <div class="easter-egg-content" @click.stop>
        <button class="close-btn" @click="showEasterEgg = false">×</button>
        <h3>✨ You Found the Secret! ✨</h3>
        <p>
          You have the eyes of an explorer! Here's a special message just for
          you:
        </p>
        <div class="secret-message">
          <p>
            "The night sky holds infinite possibilities, just like your
            potential."
          </p>
        </div>
        <div class="constellation">
          <div
            ...
            :key="index"
            :style="`top: ${star.y}%; left: ${star.x}%; animation-delay: ${star.delay}s;`"
          ></div>
        </div>
        <p class="hint">Click anywhere to close</p>
      </div>
    </div>
    ...
    <div class="container position-relative" style="z-index: 2">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 text-center text-light">
          ...
          <p class="hint-text">
            Hint: Try clicking on the moon or exploring the night sky...
          </p>
        </div>
      </div>
    </div>
...
// Generate random stars for easter egg
const generateConstellationStars = () => {
  constellationStars.value = [];
  for (let i = 0; i < 20; i++) {
...
.contact-section {
  ...
  /* Fade effect */
  -webkit-mask-image: linear-gradient(to bottom, transparent, #121212 10%);
  -webkit-mask-repeat: no-repeat;
  -webkit-mask-size: cover;

  mask-image: linear-gradient(to bottom, transparent, #121212 10%);
