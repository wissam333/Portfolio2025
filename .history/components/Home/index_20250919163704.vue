...
.glow-cursor {
  ...
  height: 12px;
  border-radius: 50%;
  background: rgba(255, 255, 255, 0.2); /* very soft */
...
.glow-cursor.glow {
  ...
  background: radial-gradient(
    ...
    /* soft center */ rgba(255, 255, 255, 0.05) 60%,
    /* very faint edges */ transparent 100%
  );
...
.glow-cursor.flashlight {
  ...
  background: radial-gradient(
    ...
    /* softer highlight */ rgba(255, 255, 255, 0.02) 60%,
    /* fade gently */ transparent 100%
  );
  box-shadow: 0 0 50px rgba(213, 213, 213, 0.152),
    /* soft green halo */ 0 0 80px rgba(79, 192, 141, 0.2);
  mix-blend-mode: screen;
}
