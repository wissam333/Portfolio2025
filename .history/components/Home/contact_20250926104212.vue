      ...
      <div class="row align-items-center contact-main-row">
        ...
        <div class="col-lg-6 text-center text-light effect-layer">
          <div class="night-illustration" ref="container">
            <!-- Inside the floating-astronaut div, add these elements -->
            <div
            ...
            >
              ...
              <div
                class="oxygen-tube"
                :style="{ transform: `rotate(${tubeRotation}deg)` }"
              ></div>
...
// Add these styles to the existing SCSS
...
.astronaut-leg {
  ...
  &.left {
    left: 8px;
    transform: rotate(-10deg);
    animation: leg-float-left 6s ease-in-out infinite;
  }

  &.right {
    right: 8px;
    transform: rotate(10deg);
    animation: leg-float-right 6s ease-in-out infinite;
  }
...
/* Enhanced floating animation with legs */
@keyframes float {
  0% {
    transform: translate(0, 0) rotate(0deg);
  }
  ...
  40% {
    transform: translate(30px, -70px) rotate(-2deg);
  }
  60% {
...
/* Special leg animations when on moon */
.floating-astronaut.on-moon {
  .astronaut-leg.left {
    animation: moon-walk-left 3s ease-in-out infinite;
  }

  .astronaut-leg.right {
    animation: moon-walk-right 3s ease-in-out infinite;
  }
}

@keyframes moon-walk-left {
  0%,
  100% {
