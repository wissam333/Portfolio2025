<template>
  <div ref="target" class="social-icons" :class="isVisible ? 'v-show-reveal' : 'v-hide-slide-right'">
    <div class="icons-inner">
      <div class="icons-container">
        ...
        <div class="icon-link" @click="changeLang">
          <span class="social-icon">{{ $i18n.locale == "ar" ? "EN" : "AR" }}</span>
        </div>
      </div>
    </div>
  </div>
...
const icons = [
  { name: "Facebook", url: "https://www.facebook.com/share/1Kv7doif6T/", iconName: "mdi:facebook" },
  { name: "LinkedIn", url: "https://www.linkedin.com/in/wissam-najjom-09ba06171?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app", iconName: "mdi:linkedin" },
  { name: "GitHub", url: "https://github.com/wissam333", iconName: "mdi:github" },
];
