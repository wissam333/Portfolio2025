...
function getFastPreviewUrl(url: string): string {
  ...
  try {
    ...
    // Free tier: 50 screenshots/day
    return `https://api.url2png.com/v6/P3D2B2904C7E5E/8a8f6c5c6f96f3a7b3a3a3a3a3a3a3a/png/?url=${encodedUrl}&viewport=${props.width}x${props.height}&thumbnail_max_width=400`;
  } catch {
