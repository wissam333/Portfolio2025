<template>
  ...
  <transition name="fade">
    <div
      v-if="toastMessage"
      class="fixed bottom-10 left-1/2 transform -translate-x-1/2 bg-purple-700 text-white px-6 py-3 rounded-lg shadow-lg"
    >
      {{ toastMessage }}
    </div>
  </transition>
...
function onBurstTriggered() {
  if (!useEasterEggs().value.find((e) => e == 5)) {
    ...
    showToast("Yay! You found the easter egg 🎉");
  }
}
