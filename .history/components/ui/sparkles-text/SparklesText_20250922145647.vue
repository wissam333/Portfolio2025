<template>
  <div class="text-6xl font-bold" :class="props.class">
    <span class="relative inline-block" ref="containerRef">
      <!-- Ambient sparkles -->
      <div class="stars">
      ...
      <!-- Burst stars -->
      <div class="burst-layer" @mousemove="handleMouseMove">
...
function handleMouseMove(e: MouseEvent) {
  ...
  if (velocity > 0.5) spawnBurst(offsetX, offsetY, vx, vy, velocity);
