...
const { width: windowWidth } = useWindowSize(); // SSR-safe, returns 0 on server

const canvasWidth = computed(() => (windowWidth.value < 768 ? "250" : "600"));
const canvasHeight = computed(() => (windowWidth.value < 768 ? "200" : "600"));
