...
.seasonal-container.winter {
  background: linear-gradient(180deg, #000000 0%, #10102d 50%, #150e2e 100%);
}

.seasonal-container.spring {
  background: linear-gradient(180deg, #000000 0%, #1e2a1e 50%, #212921 100%);
}

.seasonal-container.summer {
  background: linear-gradient(180deg, #000000 0%, #1c1c27 50%, #212128 100%);
}

.seasonal-container.autumn {
  background: linear-gradient(180deg, #000000 0%, #261b11 50%, #30271e 100%);
}
