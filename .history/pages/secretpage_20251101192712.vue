...
.seasonal-container.winter {
  background: linear-gradient(180deg, #000000 0%, #1a1a4a 50%, #150e2e 100%);
}

.seasonal-container.spring {
  background: linear-gradient(180deg, #000000 0%, #2a3a2a 50%, #212921 100%);
}

.seasonal-container.summer {
  background: linear-gradient(180deg, #000000 0%, #2a2a3a 50%, #212128 100%);
}

.seasonal-container.autumn {
  background: linear-gradient(180deg, #000000 0%, #3a2a1a 50%, #30271e 100%);
}
