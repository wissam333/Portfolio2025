...
export default {
  ...
  methods: {
    initFluidSimulation() {
      ...
      function getSupportedFormat(gl, internalFormat, format, type) {
        if (
          !this.supportRenderTextureFormat(gl, internalFormat, format, type)
        ) {
  ...
  `
      ...
      function update() {
        ...
        if (splatStack.length > 0) this.multipleSplats(splatStack.pop());
