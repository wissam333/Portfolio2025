...
const moonBeforeStyle = computed(() => {
  ...
  if (illumination === 0) {
    ...
    return {
      opacity: 1,
      background: "#04162E",
      boxShadow: "inset 0px 0 7px 0px #0000",
      borderRadius: "50%",
    ...
    return {
      opacity: 0,
      background: "#0000",
      boxShadow: "inset 0 0 7px 0px #0000",
      borderRadius: "50%",
  ...
  if (isWaxing) {
    ...
    return {
      opacity: 1,
      background: illumination < 0.5 ? "#0000" : "#0000",
      boxShadow: `inset ${shadowPosition}px 0 7px 0px ${
        illumination < 0.5 ? "#0000" : "#0000"
      }`,
...
const moonAfterStyle = computed(() => {
  ...
  if (isWaxing) {
    ...
    return {
      opacity: 1,
      background: illumination > 0.5 ? "#0000" : "#04162E",
      boxShadow: `inset ${shadowPosition}px 0 7px 0px ${
        illumination > 0.5 ? "#04162E" : "#0000"
      }`,
      borderRadius: illumination === 0.5 ? "0" : "50%",
      transform: illumination > 0.5 ? "rotate(0deg)" : "rotate(180deg)",
    };
...
.moon-before {
  background: #000000;
  box-shadow: inset -10px 0 7px 0px #0000;
}
