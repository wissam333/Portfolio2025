...
.seasonal-container.winter {
  background: linear-gradient(180deg, #000000 0%, #10102d 50%, #0e0a1f 100%);
}

.seasonal-container.spring {
  background: linear-gradient(180deg, #000000 0%, #1e2a1e 50%, #121612 100%);
}

.seasonal-container.summer {
  background: linear-gradient(180deg, #000000 0%, #1c1c27 50%, #151519 100%);
}

.seasonal-container.autumn {
  background: linear-gradient(180deg, #000000 0%, #261b11 50%, #201a15 100%);
}
